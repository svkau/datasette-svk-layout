...
<div class="hook"></div>
<ul>
  <li><a class="dropdown-sort-asc" href="#">Sortera stigande</a></li>
  <li><a class="dropdown-sort-desc" href="#">Sortera fallande</a></li>
  <li><a class="dropdown-facet" href="#">Facettera enligt detta</a></li>
  <li><a class="dropdown-hide-column" href="#">Dölj den här kolumnen</a></li>
  <li><a class="dropdown-show-all-columns" href="#">Visa alla kolumner</a></li>
  <li><a class="dropdown-not-blank" href="#">Visa rader som inte är tomma</a></li>
</ul>
...
(function () {
  ...
  rows.forEach((row) => {
    ...
    a.setAttribute("href", "#");
    a.setAttribute("aria-label", "Ta bort detta filter");
